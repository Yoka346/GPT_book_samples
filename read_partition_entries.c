...
int main(void)
{
    ...
    size_t entries_size = sizeof(PartitionEntry) * header.num_of_partition_entry;
    PartitionEntry* entries = (PartitionEntry*)malloc(entries_size);
    load_partition_table(dh, &header, entries, entries_size);
